...
pub async fn create_log(
    ...
    let id = db::logs::insert_log(&state.pool, &insert).await?;
...
pub async fn create_batch(
    ...
    let ids = db::logs::insert_logs_batch(&state.pool, &inserts).await?;
...
pub async fn list_logs(
    ...
    let logs = db::logs::query_logs(&state.pool, &query).await?;
...
pub async fn get_log(
    ...
    match db::logs::get_log(&state.pool, id).await? {
...
pub async fn list_apps(
    ...
    let apps = db::logs::list_apps(&state.pool).await?;
